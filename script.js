...
// Asegúrate de tener eventos para los botones
playPauseButton.addEventListener('click', playhouse);
document.getElementById('stop-button').addEventListener('click', stop); // Agregar un botón de detener
